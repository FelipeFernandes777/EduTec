...
export default function CourseInformations({
  ...
  return (
    ...
    <div className="relative bg-[#F1F1F1] min-h-screen text-[#05365F] font-sans overflow-hidden">
      ...
      <div
        className="absolute top-0 left-0 w-full h-full bg-gradient-radial from-[#00b153]/5 via-[#05365F]/5 to-transparent pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative max-w-5xl mx-auto p-4 sm:p-6 md:p-8 z-10">
        ...
        <Link
          ...
          className="group relative mb-8 inline-flex items-center gap-2 overflow-hidden rounded-full bg-[#05365F] px-5 py-2 text-sm font-bold text-[#f7f5ec] shadow-md transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,177,83,0.4)]"
        >
        ...
        <div className="bg-[#f7f5ec] rounded-xl p-8 shadow-lg shadow-slate-900/20">
          <header className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="flex flex-col gap-4">
              <span className="font-semibold text-[#00b153]">
                {cardData?.subTitle}
              </span>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-[#05365F] tracking-tight">
                {course.title}
              </h1>
            ...
            <div className="relative">
              ...
              <button
                onClick={openModal}
                className="mt-6 w-full flex flex-col items-center justify-center gap-1 bg-[#00b153] text-[#f7f5ec] p-4 rounded-lg font-bold text-lg transition-all duration-300 shadow-[0_0_15px_rgba(0,177,83,0.4)] hover:shadow-[0_0_25px_rgba(0,177,83,0.7)] hover:scale-105"
              >
        ...
        <main className="mt-16 md:mt-24 space-y-8">
          <div className="bg-[#f7f5ec] rounded-xl p-8 shadow-lg shadow-slate-900/20">
            <h2 className="text-2xl font-bold text-[#00b153] mb-4 flex items-center gap-3">
              <Info /> Sobre o Curso
            </h2>
            <p className="text-[#05365F]/90 leading-relaxed">
          ...
          {course.whatYouWillLearn && course.whatYouWillLearn.length > 0 && (
            <div className="bg-[#f7f5ec] rounded-xl p-8 shadow-lg shadow-slate-900/20">
              <h2 className="text-2xl font-bold text-[#00b153] mb-6 flex items-center gap-3">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                {course.whatYouWillLearn.map((item, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <CheckCircle
                      className="text-[#00b153] mt-1 flex-shrink-0"
                      size={20}
                    />
          ...
          {course.sections.map((section, index) => (
            <div
              key={index}
              className="bg-[#f7f5ec] rounded-xl p-8 shadow-lg shadow-slate-900/20"
            >
              <h2 className="text-2xl font-bold text-[#00b153] mb-4 flex items-center gap-3">
          ...
          {course.depoiments && (
            <div className="bg-[#f7f5ec] rounded-xl p-8 shadow-lg shadow-slate-900/20">
              <blockquote className="text-center">
                <p className="text-xl italic text-[#05365F]">
                  "{course.depoiments.texto}"
                </p>
                <footer className="mt-6">
                  <p className="font-bold text-[#00b153]">
