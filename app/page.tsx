        ...
        />
          <a href="https://www.instagram.com/edutec_brasil/"
             ...
             className="absolute bottom-15 right-4 p-2 rounded-full">
              <Instagram className="text-white hover:text-pink-600 transtion"/>
          </a>
          <a href="https://www.youtube.com/@EduTecBrasil"
             target="_blank"
             rel="noopener noreferrer"
             className="absolute bottom-26 right-4 p-2 rounded-full">
              <Youtube className="text-white hover:text-red-600 transtion rounded-full"/>
          </a>
